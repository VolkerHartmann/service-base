...
import edu.kit.datamanager.domain.UnknownInformationConstants;
import edu.kit.datamanager.repo.domain.acl.AclEntry;
import edu.kit.datamanager.service.IDataResourceService;
import edu.kit.datamanager.util.SpecUtils;
...
public class DataResourceService implements IDataResourceService {
  ...
  public DataResource create(DataResource resource, String callerPrincipal, String callerFirstName, String callerLastName) {
    ...
    for (edu.kit.datamanager.domain.Date d : resource.getDates()) {
      if (edu.kit.datamanager.domain.Date.DATE_TYPE.CREATED.equals(d.getType())) {
    ...
    if (!haveCreationDate) {
      ...
      edu.kit.datamanager.domain.Date creationDate = new edu.kit.datamanager.domain.Date();
      creationDate.setType(edu.kit.datamanager.domain.Date.DATE_TYPE.CREATED);
